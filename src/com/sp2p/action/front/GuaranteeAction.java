...
//		request().setAttribute("inverseRecorde", inverseRecorde);
	...
	public String userRenRenMethod() throws Exception {
		String flag = SqlInfusionHelper.filteSqlInfusion(request().getParameter("flag"));
	...
	public String queryUserFriendList() throws SQLException, Exception {
		...
		String attention = SqlInfusionHelper.filteSqlInfusion(paramMap.get("attention"));
	...
	public String queryUserBorrowLists() throws Exception{
		String userIdStr = SqlInfusionHelper.filteSqlInfusion(paramMap.get("id"));
