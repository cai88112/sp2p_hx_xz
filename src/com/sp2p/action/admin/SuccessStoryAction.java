...
public class SuccessStoryAction extends BasePageAction {
	...
	public String addSuccessStory()throws Exception{
		String publisher=SqlInfusionHelper.filteSqlInfusion(paramMap.get("publisher"));
		String sort=SqlInfusionHelper.filteSqlInfusion(paramMap.get("sort"));
		...
		String browseNum=SqlInfusionHelper.filteSqlInfusion(paramMap.get("browseNum"));
