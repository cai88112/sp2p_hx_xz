...
public class DownloadAction extends BasePageAction {
	...
	*/
	public String addDownload() throws Exception{
		...
		String title = SqlInfusionHelper.filteSqlInfusion(paramMap.get("title")); //标题
	    
		int visits = Convert.strToInt(paramMap.get("visits"),0); //浏览次数
		String content = SqlInfusionHelper.filteSqlInfusion(paramMap.get("content")); //详细内容
		String attachment = SqlInfusionHelper.filteSqlInfusion(paramMap.get("attachment")); //详细内容
	...
	*/
	...
	public String updateDownload() throws Exception{
		...
		String content = SqlInfusionHelper.filteSqlInfusion(paramMap.get("content")); //详细内容
		String attachment = SqlInfusionHelper.filteSqlInfusion(paramMap.get("attachment")); //附件路径
