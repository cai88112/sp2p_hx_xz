...
public class MailBoxManagerAction extends BasePageAction {
	...
	public String queryMailBoxListPage() throws Exception {
		...
		String beginTime = SqlInfusionHelper.filteSqlInfusion(paramMap.get("beginTime"));
		String endTime = SqlInfusionHelper.filteSqlInfusion(paramMap.get("endTime"));
		String senders = SqlInfusionHelper.filteSqlInfusion(paramMap.get("sender"));
		String sender = null;
		if (StringUtils.isNotBlank(senders) && !senders.equals("\\")) {
			...
			if (map != null) {
				sender = SqlInfusionHelper.filteSqlInfusion(map.get("id"));
			}
		}
		try {
	...
	public String addMail() throws IOException, DataException, SQLException {
		String receiver = SqlInfusionHelper.filteSqlInfusion(Convert.strToStr(paramMap.get("receiver"), null));
		String title = SqlInfusionHelper.filteSqlInfusion(Convert.strToStr(paramMap.get("title"), null));
		String content = SqlInfusionHelper.filteSqlInfusion(Convert.strToStr(paramMap.get("content"), null));
	...
	public String updateMailBox() throws Exception {
		...
		String title = SqlInfusionHelper.filteSqlInfusion(paramMap.get("mailTitle"));
		String content = SqlInfusionHelper.filteSqlInfusion(paramMap.get("mailContent"));
