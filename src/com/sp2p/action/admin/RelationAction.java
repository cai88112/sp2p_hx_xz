...
public class RelationAction extends BasePageAction {
	...
	public String queryRelationInfo(){
		String userName1 = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("userName1")), null);
		String userName2 = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("userName2")), null);
		String userName3 = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("userName3")), null);
		String realName3 = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("realName3")), null);
		String startDate = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("startDate")),null);
		String endDate = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("endDate")),null);
	...
	public String queryFinancialInfo(){
		...
		String userName2 = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("userName2")), null);
		String userName3 = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("userName3")), null);
		String userName4 = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("userName4")), null);
		String realName4 = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("realName4")), null);
		String startDate = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("startDate")),null);
		String endDate = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("endDate")),null);
		long parentId = Convert.strToLong(request("parentId"), -1);
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
	...
	public String relationLevelInfo() throws Exception{
		...
		String realName = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("realName")), null);
		String startDate = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("startDate")),null);
		String endDate = Convert.strToStr(SqlInfusionHelper.filteSqlInfusion(request("endDate")),null);
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		if(StringUtils.isNotBlank(startDate)){
