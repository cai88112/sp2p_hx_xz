...
public class ArticleManageAction  extends BasePageAction{
	...
	public String queryActicleList(){
		String title   = SqlInfusionHelper.filteSqlInfusion(Convert.strToStr(paramMap.get("title"),""));
		int  parentID = Convert.strToInt(paramMap.get("parentID"), -1);
		String userName = SqlInfusionHelper.filteSqlInfusion(Convert.strToStr(paramMap.get("usernane"),""));
		try {
