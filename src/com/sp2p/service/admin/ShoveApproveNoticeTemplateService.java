...
public class ShoveApproveNoticeTemplateService extends BaseService {
	 ...
	 * @throws SQLException 
	 */
	public Long addApproveNoticeTemplate(int notice_id ,String name,String template,String nid  ) throws Exception{
	 ...
	 * @throws Exception 
	 */
	public Long updateApproveNoticeTemplate(int id,int notice_id ,String name,String template,int sort ) throws Exception {
		Connection  conn = MySQL.getConnection();
		long result = -1L;
		try {
	 ...
	 * @throws Exception 
	 */
	public Long deleteApproveNoticeTemplate(int id) throws Exception{
		Connection  conn = MySQL.getConnection();
		long result = -1L;
		try {
	 ...
	 * @throws Exception 
	 */
	public void queryApproveTemplatePageAll(PageBean<Map<String,Object>>  pageBean) throws Exception {
		Connection  conn = MySQL.getConnection();
		try {
	 ...
	 * @throws DataException 
	 */
	public Map<String,String> queryApproveTemplateById(int id) throws Exception{
		Connection  conn= MySQL.getConnection();
	 ...
	 * @throws DataException
	 */
	public void queryOrderRechargeRecords(PageBean<Map<String,Object>> pageBean,int notice_style,int id,int sid) throws Exception{
	...
	public List<Map<String, Object>> queryAllInformTemplate() throws Exception{
