...
public class ShoveApproveNoticeStyleService extends  BaseService {
		 ...
		 */
		public void queryApproveNoticeStylePageAll(  PageBean<Map<String,Object>>  pageBean ,int notice_style) throws Exception{
		 ...
		 * @throws DataException 
		 */
		public List<Map<String,Object>> queryApproveNoticeStyleAll(int notice_style) throws Exception{
			Connection conn=MySQL.getConnection();
		 ...
		 * @throws SQLException 
		 */
		public Map<String,String> queryApproveNoticeStyleById(int id) throws Exception {
			Connection  conn = MySQL.getConnection();
		 ...
		 * @throws SQLException 
		 */
		public Long updateApproveNoticeStyle(int id,String title,int sort) throws Exception {
			Connection  conn = MySQL.getConnection();
			long  result = -1L;
			try {
		 ...
		 * @throws SQLException 
		 */
		public Long addApproveNoticeStyle(int id,int notice_style,String title ,int notic_type,String nid,int sort) throws Exception {
			Connection  conn = MySQL.getConnection();
			long  result = -1L;
			try {
