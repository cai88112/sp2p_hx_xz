...
public class BorrowDao {
	...
	public Long addBorrow(Connection conn, String title, String imgPath,
			...
			double frozen_margin,String json,String jsonState,int sorts) throws SQLException {
...
//	}
	...
	*/
	public List<Map<String, Object>> queryBorrow(Connection conn) throws SQLException, DataException {
		...
		sql.append("select id,borrowWay,borrowTitle,publisher from t_borrow where remainTimeStart < remainTimeEnd and borrowStatus = 2");
	...
	*/
	 ...
	 * @throws DataException
	 */
	public Map<String, String> queryBorrowhasInvestAmount(Connection conn, long id) throws SQLException, DataException {
		StringBuffer command = new StringBuffer();
		command.append("SELECT hasInvestAmount, tradeNo, isDayThe FROM t_borrow WHERE borrowStatus = 2 and id ="+id+";");
		DataSet dataSet =MySQL.executeQuery(conn, command.toString());
		command=null;
		return DataSetHelper.dataSetToMap(dataSet);
	}
