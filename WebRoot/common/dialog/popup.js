...
function getValue(str)
{
	...
	switch(str)
	{
		case "scrollTop":if(typeof(window.pageYOffset)!='undefined')
		{
		...
		case "clientWidth":if(typeof(document.compatMode)!='undefined'&&document.compatMode!='BackCompat')
		{
		...
		case "clientHeight":if(typeof(document.compatMode)!='undefined'&&document.compatMode!='BackCompat')
		{
		...
		case "scrollWidth":if(typeof(document.compatMode)!='undefined'&&document.compatMode!='BackCompat')
		{
		...
		case "scrollHeight":if(typeof(document.compatMode)!='undefined'&&document.compatMode!='BackCompat')
		{
...
Popup.prototype=
{
	iframeIdName:'ifr_popup',initialize:function (config)
	{
		...
		{
			contentType:1,isHaveTitle:true,scrollType:'yes',isBackgroundCanClick:false,isSupportDraging:true,isShowShadow:true,isReloadOnClose:true,width:400,height:300
		},config||
		{
	...
	},build:function ()
	{
		...
		var close='<input type="image" id="dialogBoxClose" src="../common/dialog/dialogclose.gif" border="0" width="28" height="15" align="absmiddle" title="关闭"/>';
...
function ShowConfirm(title,confirmCon,CallBackName,width,height)
{
	...
	pop.setContent("parameter",{obj:pop,CallBack:CallBackName});
	pop.build();
	pop.show();
}
