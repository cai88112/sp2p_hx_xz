...
<table>
					<tr>
								<td colspan="2" class="blue12 left">
									...
									<s:radio name="paramMap.status" list="#{4:'复审通过',6:'复审不通过'}" value="%{paramMap.status}"></s:radio>
							...
							<tr>
							    <td colspan="2" class="blue12 left">
									...
									<br/><s:textarea cssStyle="margin-left:80px;" name="paramMap.auditOpinion" value="%{paramMap.auditOpinion}" cols="30" rows="10"></s:textarea>
								</td>
							</tr>
							<tr>
