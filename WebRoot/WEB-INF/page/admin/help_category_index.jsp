					...
					<div style="padding-right: 10px; padding-left: 10px; padding-bottom: 10px; width: auto; padding-top: 10px; background-color: #fff;">
						<div>
							<table id="gvItem" style="width: 100%; color: #333333;"
										...
										<tr id="${id }" class="gvItem">
											...
											<td>
												...
												<a id="gvNews_ctl05_lbEdit"
													href="updateHelpCategoryInit.do?typeId=${id}">编辑</a>
												&nbsp;&nbsp;
								...
								<s:else>
									<tr><td class="gvItem" style="text-align: center;background-color: #f7f7f7;" colspan="8">暂无数据</td></tr>
								</s:else>
						  ...
						  <tbody>
								  <tr>
			                            <td height="36" align="right" class="blue12">
			                                &nbsp;</td>
			                            <td align="right">
			                                  <button  id="btnSave" style="background-image: url('../images/admin/btn_queding.jpg');width: 70px;border: 0;height: 26px" onclick="saveOrder();" ></button>
