				...
				<div style="padding: 15px 10px 0px 10px;">
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100"  class="main_alll_h2">
									<a href="updateNewsInit.do?id=${paramMap.id}">修改网站公告</a>
								</td>
								<td>
									&nbsp;
								</td>
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:select id="tb_titile_type" name="paramMap.noticeType" list="#{'00':'网站公告','01':'媒体报道'}"></s:select>
									
									<span class="require-field">*<s:fielderror fieldName="paramMap['noticeType']"></s:fielderror></span>
								</td>
							</tr>
