			...
			<div id="right"
				...
				<div style="padding: 15px 10px 0px 10px;">
					...
					<div class="tab">
						...
						<s:hidden name="tradeNo" value="%{borrowMFullScaleDetail.tradeNo}"></s:hidden>
						<s:hidden name="hasInvestAmount" value="%{borrowMFullScaleDetail.hasInvestAmount}"></s:hidden>
						<br />
					</div>
				</div>
			</div>
			<div id ="jumptoPage"></div>
	...
	$(function(){
	  //提交表单
   	 $('#btn_save').click(function(){
	     ...
	     param['paramMap.tradeNo'] = $('#tradeNo').val();
	     $.shovePost('updateBorrowFullScale.do',param,function(data){
		   ...
		   if(callBack == undefined || callBack == ''){
		       ...
		       $('#content').html(data);
		      // alert($("html").parents());
		      // $("html").parents().document.getelementbyid('qianduoduoform').html(data);
		       
		      // $('#qianduoduoform').html(data);	
		   }else{
		       if(callBack == 1){
		    	   falg = true;
		          alert("操作成功!");
	   ...
	   $('#btn_reback').click(function(){
	     ...
	     if(r == true){
	        ...
	        param['paramMap.id'] = $('#id').val();
	        param['paramMap.tradeNo'] = $('#tradeNo').val();
	        param['paramMap.hasInvestAmount'] = $('#hasInvestAmount').val();
