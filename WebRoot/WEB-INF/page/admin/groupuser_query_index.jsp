...
<html>
	<head>
	   ...
	   function initListInfo(praData) {
	   		...
	   		$.shovePost("queryGroupUsersInfo.do",param,initCallBack);
   		}
   		...
   		function deleteById(ids){
	 		if(window.confirm("确定要删除吗?")){
	 			window.location.href = "deleteGroupUser.do?id="+ids;
	 		}
   		}
						...
						<tbody>
							<tr>
								<td class="f66" align="left" width="50%" height="36px">
									...
									用户组：<s:select id="groupId" list="groupList" name="paramMap.groupId" theme="simple" listKey="id" listValue="groupName"
