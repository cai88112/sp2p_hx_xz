...
<html>
	...
	<body>
		<form id="addLinks" name="addLinks" action="addIndexRollImgInfo.do"
			method="post">
			<div id="right">
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							...
							<tr>
								...
								<td>
									<s:select id="paramMap.cardStatus" name="paramMap.cardStatus"
										list="#{-1:'-请选择-',2:'投资广告',3:'首页滚动图片'}"></s:select>
									<span class="require-field"><s:fielderror
											fieldName="paramMap['cardStatus']"></s:fielderror>
									</span>
								</td>
							</tr>
							...
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield id="tb_id" name="paramMap.serialCount"
										readonly="true" cssClass="in_text_2" cssStyle="width: 150px"
										theme="simple"></s:textfield>
									<span class="require-field"><s:fielderror
											fieldName="paramMap['serialCount']"></s:fielderror>
									</span>
								</td>
							</tr>
							<tr>
								...
								<td align="left" class="f66">
									...
									<span class="require-field"><s:fielderror
											fieldName="paramMap['ordershort']"></s:fielderror>
									</span>
								</td>
							</tr>
							<tr>
								...
								<td align="left" class="f66">
									...
									<span class="require-field"><s:fielderror
											fieldName="paramMap['companyURL']"></s:fielderror>
									</span>
								</td>
							</tr>
							<tr>
								...
								<td align="left" class="f66">
									<s:textfield name="paramMap.publishTime" cssClass="in_text_2"
										...
										id="publishtime"></s:textfield>
									<!-- <s:date name="paramMap.publishTime" format="dd/MM/yyyy" /> -->
									<span class="require-field">*<s:fielderror
											fieldName="paramMap['publishTime']"></s:fielderror>
									</span>
								</td>
							</tr>
							<tr>
								...
								<td>
									...
									&nbsp; &nbsp;
									<span class="require-field"><s:fielderror
											fieldName="actionMsg" theme="simple"></s:fielderror>
									</span>
								</td>
							</tr>
						</table>
