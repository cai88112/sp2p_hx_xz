		...
		<script type="text/javascript">
			$(function(){
				...
				$("#excelout").click(function(){
                     ...
                     window.location.href=encodeURI(encodeURI("exportUserFundRecharge.do?userId="+userId+"&&rechargeTime="+$("#rechargeTime").val()+"&&statss="+$("#status").val()+"&&reType="+$("#rechargeType").val()));
                });
			});
			
			function initListInfo(param){
				param["paramMap.rechargeTime"] = $("#rechargeTime").val();
							...
							<tbody>
								<tr>
									<td class="f66" align="left" width="50%" height="36px">
										...
										提现时间：
										<input id="rechargeTime" name="paramMap.rechargeTime" type="text"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:'readOnly'})"/>
										&nbsp;&nbsp;
