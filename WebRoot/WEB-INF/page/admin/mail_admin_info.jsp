...
<script type="text/javascript">
  function sendSMS(){
       var url="sendMailInit.do";
   	 ShowIframe("发送站内信",url,600,400);
  }
  function close(){
    window.location.href="queryMailBoxListInit.do";
      ClosePop();
   }
</script>
	...
	<table style="border-collapse: collapse; border-color: #cccccc"
		...
		<tbody>
			<tr>
				...
				<td align="right">
				<input id="btnDel" onclick="sendSMS()" type="button"
						value="发送站内信" name="btnDel" />
						</td>
			</tr>
		</tbody>
	</table>
