		...
		<script type="text/javascript" language="javascript">
	  	  ...
	  	  if($('#paramMap_img').val() == ''){
				...
				$("#btn_save").click(function(){
				 if($("#gTip").html()==""){//add by houli，在中级经纪人帐户填写正确的情况下才进行提交
						$(this).hide();
						$("#addAdmin").submit();
						return false;
					}
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28" class="xxk_all_a">
									<a href="queryEconomyInitMiddle.do">中级经纪人列表</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="100" class="main_alll_h2">
									<a href="addEconomyInitMiddle.do">添加中级经纪人</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
					...
					<div style="width: auto; background-color: #FFF; padding: 10px;">
						<table width="100%" border="0" cellspacing="1" cellpadding="3">
							<tr>
								...
								<s:else>
								<s:select list="parentList" name="paramMap.parentId" listKey="id" 
								listValue="userName" headerKey="-1" headerValue="--请选择--" disabled="true"  ></s:select>
								</s:else>
								</s:if>	
