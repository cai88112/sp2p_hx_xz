		...
		<script type="text/javascript" language="javascript">
	  	  ...
	  	  if($('#paramMap_img').val() == ''){
				...
				$("#btn_save").click(function(){
				 if($("#gTip").html()==""){//add by houli，在高级经纪人帐户填写正确的情况下才进行提交
						$(this).hide();
						$("#addAdmin").submit();
						return false;
					}
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="100" height="28" class="xxk_all_a">
									<a href="queryEconomyInitTop.do">高级经纪人列表</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
								<td width="100" class="main_alll_h2">
									<a href="addEconomyInitTop.do">添加高级经纪人</a>
								</td>
								<td width="2">
									&nbsp;
								</td>
