...
份&nbsp;&nbsp; </div></td>
 -->
  ...
  <div class="ifbox2">
    ...
    <div class="boxmain">
    <p class="xydj">富壹代信用等级：<img src="images/ico_${borrowUserMap.credit}.jpg" title="${borrowUserMap.creditrating}分" width="33" height="22" /> <span>富壹代信用额度： ${borrowUserMap.creditLimit}</span></p>
    <div class="tips">
    以下基本信息资料，经用户同意披露。其中<span class="fred">红色</span>字体的信息，为通过富壹代审核之项目。<br/>
    </div>
    <div class="infotab">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
  ...
  <div class="ifbox2">
    ...
    <div class="boxmain">
    <div class="box">
    <div class="tips">富壹代将以客观、公正的原则，最大程度地核实借入者信息的真实性，但不保证审核信息100%真实。如果借入者长期逾期，其提供的信息将被公布。 </div>
