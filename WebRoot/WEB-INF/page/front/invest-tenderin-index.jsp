  ...
  <div class="wdzh">
    ...
    <div class="r_main">
      <div class="tabtil">
        ...
        <li id="lab_2"  dataIndex="true" class="on"  onclick="jumpUrl('homeBorrowInvestList.do');">招标中的借款</li>
        <li id="lab_3"  onclick="jumpUrl('homeBorrowInvestList.do');">回收中的借款</li>
        <li id="lab_4"  onclick="jumpUrl('homeBorrowInvestList.do');">已回收的借款</li>
        <li id="lab_5"  onclick="jumpUrl('homeBorrowInvestList.do');">回账查询</li>
        </ul>
        </div>
<div class="box">
        <div class="boxmain2">
