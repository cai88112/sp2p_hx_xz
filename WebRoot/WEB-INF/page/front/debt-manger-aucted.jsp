  ...
  <div class="wdzh">
    <div class="l_nav">
      ...
      <div class="tabtil">
       ...
       <li class="on" onclick="goUrl('queryAuctedDebt.do');">竞拍结束的债权</li>
...
<div class="box" >
        <div class="boxmain2">
        <form id="searchForm" action="queryAuctedDebt.do">
    ...
    <s:else>
	  <s:iterator value="pageBean.page" var="bean">
		  <tr>
		    ...
		    <td align="center">
		    <s:if test="#bean.debtStatus==3">竞拍成功</s:if>
		    <s:elseif test="#bean.debtStatus==4">竞拍失败</s:elseif>
								...
								<s:elseif test="#bean.debtStatus==7">提前还款</s:elseif></td>
		<td align="center">
		    	   <a href="getMessageBytypeId.do?typeId=24&&aid=${debtId}" target="_blank">转让协议 </a>
		    	</td>
		  </tr>
	  </s:iterator>
  </s:else>
...
<div class="page">
    		<shove:page url="queryAuctedDebt.do" curPage="${pageBean.pageNum}" showPageCount="6" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
