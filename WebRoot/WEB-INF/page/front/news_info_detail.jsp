...
<div class="nymain">
  <div class="lcnav">
    <div class="tab">
<div class="tabmain">
  <ul><li class="on" style="padding:0 20px;">公告详情</li>
  </ul>
    </div>
    </div>
    <div class="line">
  ...
  <div class="lcmain">
    ...
    <ul>
     <li style="background:none; line-height:20px">
       <s:if test="#request.previousDate!=null" >
          上一条：<a style="max-width: 30px;overflow: hidden;"  href="frontNewsDetails.do?id=${request.previousDate.id}">${request.previousDate.title}</a>
       </s:if>  
       <s:else>
         <a>&nbsp;&nbsp;&nbsp;</a>
       </s:else>
    ...
    <li style="background:none; line-height:20px">
      <s:if test="#request.lastDate!=null" >
         下一条：<a style="max-width: 30px;overflow: hidden;" href="frontNewsDetails.do?id=${request.lastDate.id}">${request.lastDate.title}</a>
      </s:if> 
      <s:else>
        <a>&nbsp;&nbsp;&nbsp;</a>
      </s:else>  
