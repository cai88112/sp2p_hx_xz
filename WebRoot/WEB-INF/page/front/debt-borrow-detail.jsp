	...
	<body>
		...
		<div class="ifbox1" style="margin-top: 20px;">
			...
			<div class="boxmain">
				<div class="pic-info">
					<div class="tx">
						<shove:img src="${paramMap.imgPath }"
				...
				<div class="reninfo">
					<div class="rinfomain">
						<div class="tx">
							<shove:img src="${userMap.personalHead}"
			...
			<div class="ifbox2">
				...
				<div class="boxmain">
					...
					<div class="tips">
						以下基本信息资料，经用户同意披露。其中
						<span class="fred">红色</span>字体的信息，为通过富壹代审核的项目。
						审核意见：${borrowDetailMap.auditOpinion}
					</div>
					<div class="infotab">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
			...
			<div class="ifbox2">
				...
				<div class="boxmain">
					<div class="box">
						<div class="tips">
							富壹代将以客观、公正的原则，最大程度地核实借入者信息的真实性，但不保证审核信息100%真实。如果借入者长期逾期，其提供的信息将被公布。
						</div>
