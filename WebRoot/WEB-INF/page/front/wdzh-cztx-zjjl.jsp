...
<div class="nymain">
  <div class="wdzh">
    ...
    <div class="tabtil" style="width: 778px">
        <ul>
        <li class="on" dataIndext="true" onclick="jumpUrl('queryFundrecordInit.do');">资金记录</li>
  ...
  <tr>
    <th style="background-color: #efefef">账户总额</th>
    <th style="background-color: #efefef">可用余额</th>
    <th style="background-color: #efefef">冻结金额</th>
  </tr>
  <tr>
...
<!--        <h2 class="otherh2x">资金记录</h2> -->
      <div class="boxmain2">
        ...
        <a href="javascript:void(0)" class="cxbtn" onclick="fundRecordList();" style="background-color: #b5b5b5; border-radius: 3px; background-image: none; color: #fff; height: 19px; font-size: 10px">查询</a>
        </div>
