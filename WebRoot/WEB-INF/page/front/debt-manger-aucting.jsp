  ...
  <div class="wdzh">
    <div class="l_nav">
      ...
      <div class="tabtil">
        ...
        <li class="on" onclick="goUrl('queryAuctingDebt.do');">竞拍中的债权</li>
...
<div class="box" >
        <div class="boxmain2">
        <form id="searchForm" action="queryAuctingDebt.do">
  ...
  <tr>
    ...
    <s:iterator value="pageBean.page" var="bean">
	  <tr>
	    ...
	    <td align="center"><a href="auctingDebtEnd.do?debtId=${debtId}">成交</a> <a href="queryDebtDetail.do?id=${debtId }">查看</a></td>
	  </tr>
  </s:iterator>
   </s:else>
          </table>  
<div class="page">  
    	<shove:page url="queryAuctingDebt.do" curPage="${pageBean.pageNum}" showPageCount="6" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
