...
<div class="bigbox" style="border:none">
  <div class="sqdk" style="background:none;">
    ...
    <li style="background: none;border-bottom: #ddd 1px dashed;"><a href="portUserAcct.do" style="background-image: none;"><span>step2 </span>绑定帐号</a></li>
    ...
    <li class="on last" style="background: none;border-bottom: #ddd 1px dashed;"><a href="javascript:void(0);" style="background-image: none;"><span>step5 </span>发布贷款</a></li>
    </ul>
    </div>
    <div class="r-main">
    <%--<div class="til01">
