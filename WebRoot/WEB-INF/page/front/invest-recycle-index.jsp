  ...
  <div class="wdzh">
    ...
    <div class="r_main">
      <div class="tabtil">
        ...
        <li id="lab_3" dataIndex="true" class="on" onclick="jumpUrl('homeBorrowRecycleList.do');">回收中的借款</li>
...
<div class="box">
        <div class="boxmain2">
         <div class="srh">
          <form action="homeBorrowRecycleList.do" id="searchForm" >
...
function viewDetail(obj,obj1){
    var url = "homeBorrowForpayDetail.do?id="+obj+"&iid="+obj1;
