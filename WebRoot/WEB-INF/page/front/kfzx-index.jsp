...
<div class="nymain">
  <div class="kfbox">
    ...
    background-color: #fabe00;">帮助中心</h2>
    ...
    <h2 style="text-align:left; padding-left:20px" style=" text-align: center;  font-size: 16px;color: #fff;  
    height: 40px;  line-height: 40px;  padding: 0;background-image: none; 
    background-color: #fabe00;">
    <span><a href="javascript:void(0);" onclick="showKfs()" >更多>></a>
    </span>联系客服</h2>
...
$(function(){
    ...
    function showAnswer(id){
	 ...
	 $("#curPageText").attr("class","cpage");
	    ...
	    window.location.href="callcenter.do?cid=${cid}&curPage="+curPage+"&pageSize=${pageBean.pageSize}";
		});
