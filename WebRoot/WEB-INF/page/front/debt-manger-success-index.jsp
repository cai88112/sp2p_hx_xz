...
<div class="r_main">
      <div class="tabtil">
        <ul><li  onclick="goUrl('queryBuyingDebt.do')">参与购买的债权</li>
...
<div class="box" >
        <div class="boxmain2">
         <form id="searchForm" action="querySucessBuyedDebt.do" >
         <input type="hidden" name="curPage" id="pageNum"/>
         <div class="srh">
        竞拍时间：<input type="text" name="startTime" value="${paramMap.startTime }" onclick="WdatePicker();"  class="inp90" /> 
        到 
        <input type="text"  name="endTime" value="${paramMap.endTime }" onclick="WdatePicker();"  class="inp90" /> 
  ...
  <tr>
    ...
    <td align="center">${auctionEndTime }</td>
    <td align="center">${auctionerName }</td>
    <td align="center"><a href="queryDebtDetail.do?id=${id }" target="_blank">查看</a></td>
    <td align="center"><a href="getMessageBytypeId.do?typeId=24&&aid=${id}" target="_blank">转让协议</a></td>
  </tr>
  </s:iterator>
  </s:else>
          </table>
<div class="page"> 
    	<shove:page url="querySucessBuyedDebt.do" curPage="${pageBean.pageNum}" showPageCount="6" pageSize="${pageBean.pageSize }" theme="number" totalCount="${pageBean.totalNum}">
