...
<div class="nymain">
  <div class="kfbox">
    ...
    <div class="leftbox">
    <h3 style="background-image: none; border-bottom: #ddd 1px dashed; background: #7ecef4; font-color: white"><a href="getMessageBytypeId.do?typeId=4" style="color: white; font-size: 16px">关于我们</a></h3>
    ...
    <div id="showcontent" class="rightbox" style="height: initial;">
...
$(function(){
	...
	$("#aboutower").click(function(){
		...
		$('#mediaReport').removeClass('on');
		 ...
		 $('#aboutower').addClass('on');
	    $.post("queryMessageDetail.do","typeId=2",function(data){
	         $("#showcontent").html("");
	         $("#showcontent").html("<h3>"+data.columName+"</h3>"+
	                           "<p class='zw'>"+data.content+"</p>");
	    });
