  ...
  <div class="wdzh">
    ...
    <div class="r_main">
      <div class="tabtil">
        ...
        <li class="on" dataIndex="true" onclick="jumpUrl('queryMyPayingBorrowList.do');">正在还款的借款</li>
...
$(function(){
    ...
    function excel2(){
       	window.location.href=encodeURI(encodeURI("exportSuccessBorrow.do?status=4"+"&&startTime="+$("#startTime").val()+"&&endTime="+$("#endTime").val()+"&&title="+$("#title_s").val()));
    }
     ...
     function  initListInfo(param){
     	param["paramMap.borrowId"] = $('#borrowIdval').text();
