						...
						<form id="form1">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td>
										<input type="text" class="inp188" id="realName" />
								...
								<tr>
									...
									<td>
										<input type="text" class="inp188" id="idNo" />
								...
								<tr>
									...
									<td>
										<input type="text" class="inp188" id="idNo2" />
										<span style="color: red; float: none;" id="u_idNo2"
											class="formtips"></span>
									</td>
								</tr>
								<tr>
									...
									<td>
										<input type="text" class="inp188" id="cellPhone" />
								...
								<tr>
									...
									<td>
										<a id="clickCode" class="yzmbtn">发送手机验证码</a>
									</td>
								</tr>
								<tr>
									<td align="right">
									...
									<td>
										<input type="text" class="inp188" id="send_phoneCode" />
								...
								<tr>
									...
									<td class="tyzc">
										<a href="rechargeInit.do">我要充值</a>
										<a href="queryFundrecordInit.do">账户余额</a>
									</td>
								</tr>
								<tr>
									<th align="right">
									...
									<td>
										<a href="javascript:void(0)" class="dlbtn"
											onclick=
	addBecomeFinancer();;
>成为理财人</a>
									</td>
								...
								<tr>
									<td colspan="2" align="left"
										style="line-height: 26px; padding-top: 15px; color: #888;">
										注意：若第一次验证失败，即姓名与身份证号码不匹配。
										第二次验证，将按审核成本5元/次的标准收取验证费，请务必填写您的真实信息！进行手机绑定后，本手机号将作为富壹代和您确认贷款的途径之一，请使用您常用的手机号码进行绑定，您的手机号码不会以任何形式被泄露。
									</td>
								</tr>
							</table>
						</form>
		...
		$("#clickCode").click(function() {
			...
			//验证手机号码是
				if ($("#cellPhone").val() == "") {
					...
					if ($("#clickCode").html() == "重新发送验证码"
							|| $("#clickCode").html() == "发送手机验证码") {
						$.post("phoneCheck.do", "phone=" + phone, function(
								datas) {
							if (datas.ret != 1) {
								alert(datas.msg);
								return;
				...
				.blur(function() {
					//验证手机号码
						...
						if ($(this).attr("id") == "idNo") {
							...
							} else if (isIDCard1.test($(this).val())
									|| isIDCard2.test($(this).val())) {
								$("#u_idNo").html("");
							} else {
	...
	function addBecomeFinancer() {
		...
		//验证不通过
		if ($("#u_realName").text() != "" || $("#u_cellPhone").text() != ""
				|| $("#u_idNo").text() != "" || $("#u_idNo2").text() != ""
				|| $("#u_code").text() != "") {
			alert("请先填写完整的信息");
			return;
		}
