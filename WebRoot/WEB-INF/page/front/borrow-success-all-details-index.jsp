    ...
    <div class="r_main">
      <div class="tabtil">
       <ul><li  onclick="jumpUrl('queryMySuccessBorrowList.do');">成功借款</li>
        ...
        <li class="on" dataIndex="true" onclick="jumpUrl('queryAllDetails.do');">还款明细账</li>
...
$(function(){
    ...
    function excels(){
    	window.location.href=encodeURI(encodeURI("exportrepayment.do?startTime="+$("#startTime").val()+"&&endTime="+$("#endTime").val()+"&&title="+$("#title_s").val()));
    }
