...
<body>
	...
	<div class="nymain">
		<div class="ifbox1">
			<h2>
				确定投标 <img src="images/neiye2_06.jpg" width="4" height="7" />
			</h2>
			<div class="boxmain" style="padding-top: 20px; padding-bottom: 20px;">
				<div class="qrtb">
					...
					<div class="tbmain">
							...
							<div class="lbox">
								<div class="pic">
									<shove:img src="${investDetailMap.personalHead}"
										defaulImg="images/default-img.jpg" width="80" height="79"></shove:img>
									<br /> 富壹代信用等级： <img
										src="images/ico_${investDetailMap.credit}.jpg"
										title="${investDetailMap.creditrating}分" width="33"
										height="22" />
								</div>
								<p class="name">
									用户名：${investDetailMap.username} <br />
									籍贯：${investDetailMap.nativePro}&nbsp;${investDetailMap.nativeCity}
									<br /> 居住地：${investDetailMap.address}
								</p>
							</div>
							<div class="rbox">
								<ul>
									<li>借款标题： <strong>${investDetailMap.borrowTitle}</strong>
									</li>
									<li>借款金额： <strong>￥${investDetailMap.borrowAmount}</strong>
									</li>
									<li>借款年利率： <strong>${investDetailMap.annualRate}%</strong>
									</li>
									<li>已经完成： <strong>${investDetailMap.schedules}%</strong>
									</li>
									<li>还需借款: <strong>￥${investDetailMap.investNum}</strong>
									</li>
									<li>借款期限: <strong>${investDetailMap.deadline} <s:if
						...
						<div class="tbcz">
							<p class="money">
								您的帐户总额： <strong>${userMap.totalSum} 元 </strong> <a
									href="rechargeInit.do" class="czbtn"><img
									src="images/tubiao3.png" /> </a> <br /> 您的可用余额： <strong>${userMap.usableSum}
									元</strong>
							</p>
							<p class="tips">
								请填写并确认下面投标金额 <br />
								<s:if test="#request.subscribes!=1">
									<span class="f999">最低投标金额：<s:property
											...
											test="%{investDetailMap.maxTenderedSum != -1}">${investDetailMap.maxTenderedSum}</s:if>
										<s:else>无限制</s:else> <br />当前年利率:
										${investDetailMap.annualRate}%
									</span>
								</s:if>
								<s:else>
									<span class="f999">最小认购金额：<s:property
											value="#request.investMap.smallestFlowUnit" default="0" />元&nbsp;
										当前年利率: ${investDetailMap.annualRate}% <br />认购总份数：${investMap.circulationNumber
											}份,还有：${investMap.circulationNumber -
											investMap.hasCirculationNumber }份
									</span>
								</s:else>
							</p>
									...
									<s:if test="#request.subscribes!=1">
										<tr>
											...
											<td><input type="text" id="amount"
												name="paramMap.amount" class="inp140" maxlength="20" />元</td>
										</tr>
									</s:if>
									<s:if test="#session.hasPWD != -1">
										<tr>
											<td>投标密码：</td>
											<td><input type="password" id="investPWD"
												name="paramMap.investPWD" class="inp140" maxlength="20" />
											</td>
										</tr>
									</s:if>
									<!-- 
										<tr>
											...
											<td>
												<input type="password" id="dealPWD" name="paramMap.dealPWD"
													class="inp140" maxlength="20" />
											</td>
										</tr>
										 -->
									<s:if test="#request.subscribes!=1">
										...
										<tr>
											<td colspan="2" align="center"
												...
												id="btnsave" type="button" class="qdtbbtn" value="" /></td>
										</tr>
									</s:if>
								</table>
								<s:if test="#request.subscribes==1">
									<div
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0">
											<tbody>
												...
												<tr>
													<td colspan="2" align="center">您的可投标金额为： <font
														id="account_use" style="color: #FF0000">￥${investDetailMap.investNum}</font>元，最多可认购：
														<font style="color: #FF0000" id="roam_use">${investMap.circulationNumber
																- investMap.hasCirculationNumber}份</font>
														<input name="subscribes" type="hidden" id="subscribes"
														value="${subscribes}" /> <input name="smallestFlowUnit"
														type="hidden" id="smallestFlowUnit"
														value="${investMap.smallestFlowUnit}" />
													</td>
												</tr>
											</tbody>
										</table>
