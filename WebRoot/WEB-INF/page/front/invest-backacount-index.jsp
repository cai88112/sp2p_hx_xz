  ...
  <div class="wdzh">
    ...
    <div class="r_main">
      <div class="tabtil">
        ...
        <li id="lab_5" class="on" dataIndex="true" onclick="jumpUrl('homeBorrowBackAcountList.do');">回账查询</li>
        </ul>
        </div>
<div class="box">
        <div class="boxmain2">
<!--         <div class="srh" style="color: #000"><strong class="blue"><strong>个人贷款：</strong></div> -->
  ...
  <tr>
    ...
    <td align="center" id="allForPI">￥<s:if test="#request.backAcountStatisMap.allForPI !=''">${backAcountStatisMap.allForPI}</s:if><s:else>0</s:else></td>
         ...
         <div class="srh" style="position: relative; left: 15px">
