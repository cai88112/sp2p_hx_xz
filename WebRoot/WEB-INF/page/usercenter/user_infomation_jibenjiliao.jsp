		...
		<div class="nymain">
			<div class="bigbox" style="border:none">
				...
				<div class="sqdk" style="background: none;">
					<div class="l-nav" style="height: 300px">
						<ul>
							<li class="on" style="background: none;border-bottom: #ddd 1px dashed;"><a href="querBaseData.do?from=${from}" style="background-image: none;"><span>step1 </span>基本资料</a></li>
						 	...
						 	<li style="background: none;border-bottom: #ddd 1px dashed;"><a href="userPassData.do?from=${from}" style="background-image: none;"><span>step3 </span>上传资料</a></li>
						 	<%-- <li style="background: none;border-bottom: #ddd 1px dashed;"><a href="creditingInit.do?from=${from}" style="background-image: none;"><span>step4 </span>申请额度</a></li> --%>
						 	<li style="background: none;border-bottom: #ddd 1px dashed;"><a href="addBorrowInit.do?t=${session.t}" style="background-image: none;"><span>step4 </span>发布借款</a></li>
						</ul>
					<!-- <ul>
					...
					<div class="r-main" style="border-style: none;border-left: 1px solid #eee;border-right: 1px solid #eee">
						<div class="til01">
							<ul>
						...
						<div class="rmainbox" style="position: absolute; bottom:122px; width: 700px">
						<!-- 基础资料div -->
								...
								<div class="tab">
									<form id="BaseDataform">
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr style="position: absolute; left:26px">
												<td align="right">
											...
											<tr style="position: absolute; left:26px; top:120px">
												<td align="right">
													<span style="color: red; float: none;" 
											...
											<tr style="position: absolute; left:26px; top:160px">
					<td align="right">
...
<!-- 									<a id="clickCode" class="yzmbtn" style="cursor: pointer;">点击获取验证码</a> -->
					...
					<s:else>
						...
						<s:else>
											...
											<tr style="position: absolute; left:26px; top:194px">
												<td align="right">
													<span style="color: red; float: none;" 
...
<%-- 												<td align="right">
    ...
    - -->
											...
											<tr>
												...
												<td style="padding-top: 20px; position: absolute; left: 142px; top: 225px">
												<!--  
